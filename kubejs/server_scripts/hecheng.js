    ...
    event.shaped('celestial_artifacts:catastrophe_scroll',[
        ...
        ['iceandfire:dragonbone','iceandfire:dragonbone','iceandfire:dragonbone'],
            ...
            event.shaped('minecraft:zombie_head',[
                ...
                ['minecraft:rotten_flesh','minecraft:skeleton_skull','minecraft:rotten_flesh'],
                ['minecraft:rotten_flesh','minecraft:rotten_flesh','minecraft:rotten_flesh']
            ])

            event.shaped('minecraft:piglin_head',[
                ['minecraft:nether_wart','minecraft:nether_wart','minecraft:nether_wart'],
                ['minecraft:nether_wart','butcher:pig_corpse_item','minecraft:nether_wart'],
                ['minecraft:nether_wart','minecraft:nether_wart','minecraft:nether_wart']
            ])
